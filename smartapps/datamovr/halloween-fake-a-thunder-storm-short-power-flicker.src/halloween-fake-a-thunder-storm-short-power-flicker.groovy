 ...
 */
definition(
    name: "Halloween - Fake a thunder storm short power flicker",
    namespace: "datamovr",
    author: "Rick Hall",
    description: "Using a multi-sensor attached to a speaker, when thunder strikes in audio, switch off the lightes connected to a Smart Outlet for a few seconds, then turn them back on.",
    category: "My Apps",
...
//		input "myPresence", "capability.presenceSensor", title: "Presence Sensor?", required: false
	...
	section("Then flash..."){
		...
		input "numFlashes", "number", title: "This number of times (default 1)", required: false
	}
